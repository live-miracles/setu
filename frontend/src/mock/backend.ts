...
const mockData = {
    ...
    blocks: [
        ...
        {
            Id: 'block-5',
            Name: 'Studio A unavailable today',
            StartDateTime: mockAddDays(0) + 'T09:00:00.000Z',
            EndDateTime: mockAddDays(0) + 'T17:00:00.000Z',
            Place: 'place-1',
        },
        {
            Id: 'block-2',
            Name: 'Studio A maintenance',
            StartDateTime: mockAddDays(2) + 'T10:00:00.000Z',
            EndDateTime: mockAddDays(3) + 'T16:00:00.000Z',
            Place: 'place-1',
        },
        {
            Id: 'block-3',
            Name: 'Podcast room setup',
            StartDateTime: mockAddDays(5) + 'T08:00:00.000Z',
            EndDateTime: mockAddDays(5) + 'T18:00:00.000Z',
            Place: 'place-5',
        },
        {
            Id: 'block-4',
            Name: 'All studios closed',
            StartDateTime: mockAddDays(7) + 'T00:00:00.000Z',
            EndDateTime: mockAddDays(8) + 'T23:59:00.000Z',
            Place: '',
        },
    ] as Block[],
