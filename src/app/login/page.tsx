    ...
    <main className="login-page">
      <section className="login-visual">
        <div className="login-visual-copy">
          ...
          <p>
            One focused workspace for roster coverage, equipment handovers and
            studio support.
          </p>
        </div>
      </section>
      <section className="login-panel">
        <div className="login-card">
          ...
          <h2>Welcome back</h2>
          <p>
            Sign in with an approved Google account. Access is managed by the
            Livestream operations admins.
          </p>
          <Button
            type="primary"
            size="large"
