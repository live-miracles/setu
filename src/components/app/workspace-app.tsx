...
function WorkspaceInner() {
  ...
  const activeSection =
    section === "admin" && state.currentUser.role !== "admin"
      ? "home"
      : section;
          ...
          {!ready ? (
            ...
            <section className="surface-card" style={{ padding: 32 }}>
              ...
              <p style={{ color: "#73767d", maxWidth: 520 }}>
                Livestream Operations does not keep offline business data.
                Reconnect to load current roster, inventory and ticket
                information.
              </p>
            </section>
          )}
        ...
        <div className="list-stack">
          {state.notifications.map((notification) => (
            ...
            >
              ...
              {!notification.read && (
                <Badge status="processing" color="#ff6257" />
              )}
            </button>
          ))}
        </div>
