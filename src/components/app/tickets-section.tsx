...
import { App, Avatar, Button, Form, Input, Modal, Select, Tag } from 'antd';
...
export function TicketsSection() {
    ...
    const detailTicket = state.tickets.find((ticket) => ticket.id === detailTicketId) ?? null;
        ...
        <>
            <div className="page-heading">
                <div>
                    ...
                    <p>Capture the location, owner and full history of every studio issue.</p>
                </div>
                            ...
                            {tickets.map((ticket) => (
                                <article className="ticket-card" key={ticket.id}>
                                    ...
                                    <div className="ticket-card-footer">
                                        <span>
                                            {ticket.assignee ? (
                                                <Avatar size={26} style={{ background: '#58c9bd' }}>
            ...
            <Modal
                ...
                {detailTicket && (
                    <div className="list-stack">
                        <p style={{ color: '#686c74', marginTop: 0 }}>{detailTicket.description}</p>
                        <AttachmentUploader ownerType="ticket" ownerId={detailTicket.recordId} />
                        <div className="list-stack">
            ...
            <Modal
                ...
                <p style={{ color: '#74777f' }}>
                    The selected volunteer will receive an in-app notification, email and Web Push
                    if enabled.
                </p>
                <Select
                    value={assigneeId}
