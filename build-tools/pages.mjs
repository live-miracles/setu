...
//
//   index.html + app.{js,css}   the demo — the production UI built against the
...
//     from dev.ts, so this is the one build where that is the intent.
...
import { root, siteDir, esbuildOptions, renderDemoShell, compileCss } from './shell.mjs';
